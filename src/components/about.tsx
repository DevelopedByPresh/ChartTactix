    ...
    <section className="w-full bg-[#0d0d0d] text-white py-10" id="about">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <motion.div variants={item} className="space-y-6 order-1 md:order-2">
            ...
            <motion.h2
              ...
              className="text-3xl md:text-3xl mt-5 font-bold leading-tight"
            >
              Trusted by over <span className="text-[#A6FF00]">300,000</span> traders across all socials.
            </motion.h2>
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true }}
          className="mt-20 grid grid-cols-2 md:grid-cols-4 border-t border-white/10"
        >
          {[
            { value: "6+", label: "Years Trading Experience" },
            { value: "5k+", label: "Community Members" },
            ...
            <motion.div
              key={i}
              variants={item}
              className="py-10 flex flex-col items-center text-center border-r border-white/10 last:border-r-0"
            >
              <span className="text-3xl font-bold">{stat.value}</span>
